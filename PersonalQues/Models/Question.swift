...
struct Question {
    ...
    static func getQuestions() -> [Question] {
        [
            ...
            Question(title: "Что нравится больше?",
                     type: .multiple,
                     answers: [
            ...
            Question(title: "Любите поездки на машине?",
                     type: .ranged,
                     answers: [
...
enum AnimalType: Character {
    ...
    var definition: String {
        switch self {
        case .dog:
            return "Вам нравится быть с лрузьями. Вы окружаете себя людьми, которые вам нравятся и всегда готовы помочь."
        case .cat:
            return "Вы себе на уме. Любите гулять сами по себе. Вы цените одиночество."
        case .rabbit:
            return "Вам нравится все мягкое. Вы здоровы и полны энергии."
        case .turtle:
            return "Ваша сила в в мудрости. Медленный и вдумчивый выигрывает на длинных дистанциях."
        }
    }
}
